...
void choleskyDecompositionExample() {
  ...
  Positive-definite matrix:
      Matrix Mnxn is said to be positive definite if the scalar zTMz is strictly
  positive for every non-zero column vector z n real numbers. zTMz>0


  Hermitian matrix:
      Matrix Mnxn is said to be positive definite if the scalar z*Mz is strictly
  positive for every non-zero column vector z n real numbers. z*Mz>0 z* is the
...
void qRDecomposition(Eigen::MatrixXd &A, Eigen::MatrixXd &Q,
                     Eigen::MatrixXd &R) {
  /*
      A=QR
...
void qRExample() {
  ...
  /////////////////////////////////ColPivHouseholderQR////////////////////////
  Eigen::ColPivHouseholderQR<Eigen::MatrixXd> colPivHouseholderQR(A.rows(),
                                                                  A.cols());
  ...
  Eigen::FullPivHouseholderQR<Eigen::MatrixXd> fullPivHouseholderQR(A.rows(),
                                                                    A.cols());
