...
int main() {
  ...
  std::cout << "roll: Pi/" << M_PI / roll << " ,pitch: Pi/" << M_PI / pitch
            << " ,yaw : Pi/" << M_PI / yaw << std::endl;
  ...
  std::cout << "roll: Pi/" << M_PI / euler_angles[2] << " ,pitch: Pi/"
            << M_PI / euler_angles[1] << " ,yaw : Pi/" << M_PI / euler_angles[0]
            << std::endl;
}
