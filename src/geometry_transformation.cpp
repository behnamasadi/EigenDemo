...
void transformExample() {
  ...
  For instance, an affine transformation A is composed of a linear part L and a
  translation t such that transforming a point p by A is equivalent to:
  ...
  Ref:
  https://stackoverflow.com/questions/35416880/what-does-transformlinear-return-in-the-eigen-library

  Difference Between Projective and Affine Transformations
  1) The projective transformation does not preserve parallelism, length, and
  angle. But it still preserves collinearity and incidence. 2) Since the affine
  transformation is a special case of the projective transformation, it has the
  same properties. However unlike projective transformation, it preserves
  parallelism.
  ...
  */
  ...
  Eigen::MatrixXf mVertices =
      Eigen::Map<Eigen::Matrix<float, 3, 8>>(arrVertices);
